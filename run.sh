...
i386-elf-ld -o "Binaries/full_kernel.elf" -g -Ttext 0x1000 \
  Binaries/kernel_entry.o Binaries/kernel.o Binaries/idt_load.o \
  Binaries/vga.o Binaries/idt.o Binaries/pic.o Binaries/irq.o Binaries/irq_cpp.o 
...
qemu-system-x86_64 -s -S -drive format=raw,file="Binaries/OS.bin",index=0,if=floppy -m 128M -no-reboot # (TODO) Add way to launch with a bigger res
